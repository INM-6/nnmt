...
class Test_firing_rates_wrapper:
    ...
    func = staticmethod(binary.firing_rates)
...
class Test_firing_rates_for_given_input:

    func = staticmethod(binary._firing_rates_for_given_input)
    fixtures = 'binary_firing_rates.h5'
    rtol = 1e-7
