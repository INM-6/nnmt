...
nu_ext_ndm_a, nu_ndm_a = solve_theory(params_ndm, 0, 0.05, 5, nu_ext_steps)
nu_ext_ndm_b, nu_ndm_b = solve_theory(params_ndm, 500, 0.05, 5, nu_ext_steps)
...
plot_rates(fig.add_subplot(gs[0, 1]),
           [nu_ext_sdm_a, nu_ext_sdm_b, nu_ext_sdm_c],
           [nu_sdm_a, nu_sdm_b, nu_sdm_c], 100, 500,
           r'$\nu_X$ [spks/s]', '', 'SDM',
           colors, '(B)', label_prms)
# Response-onset supersaturation
plot_rates(fig.add_subplot(gs[0, 2]), [nu_ext_ros_a, nu_ext_ros_b],
           ...
           colors, '(C)', label_prms)
# Mean-driven multisolution
plot_rates(fig.add_subplot(gs[0, 3]), [nu_ext_mdm_a, nu_ext_mdm_b],
           [nu_mdm_a, nu_mdm_b], 10, 50,
           r'$\nu_X$ [spks/s]', '', 'MDM',
           colors, '(D)', label_prms)
# Noise-driven multisolution
plot_rates(fig.add_subplot(gs[0, 4]), [nu_ext_ndm_a, nu_ext_ndm_b],
           [nu_ndm_a, nu_ndm_b], 5, 10,
           r'$\nu_X$ [spks/s]', '', 'NDM',
           colors, '(E)', label_prms)
# save and show
