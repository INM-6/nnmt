...
Example illustrating the structure of the ring network used by
:cite:t:`senk2020`.
...
##########################################################################
# We use the Python package ``svgutils`` to integrate an externally generated
# network sketch into the figure.
...
##########################################################################
# We generate a one-column spanning figure with three panels to illustrate the
# network structure.
# Panel A will contain the external network sketch which we will add in after
