...
if __name__ == '__main__':
    ...
    # save output
    h5.save('./../Schuecker2015_data.h5', results_dict, overwrite_dataset=True)
    ...
    # axA.set_ylim(0, 15)
    # axB.set_ylim(-50, 10)
    # fig.savefig('PRE_Schuecker_Fig4_Kummer_fortran.png')
    #
    # Phi1 = Phi1_U_Kummer_mpmath
    # plot_PRE_Schuecker_Fig4(['blue', 'green'], lw=2, markersize_cross=4)
    # axA.set_ylim(0, 15)
    # axB.set_ylim(-50, 10)
    # fig.savefig('PRE_Schuecker_Fig4_Kummer_python.png')
