...
the parameters of a given network model. Other tools might help you get a
better intuitive understanding of your network model or allow mapping a model
onto another one.
...
NNMT is the successor to
`lif_meanfield_tools <https://github.com/INM-6/lif_meanfield_tools>`_.
